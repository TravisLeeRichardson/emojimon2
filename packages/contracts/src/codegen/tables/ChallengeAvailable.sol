...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ChallengeAvailab")));
bytes32 constant ChallengeAvailableTableId = _tableId;

library ChallengeAvailable {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ChallengeAvailable", _fieldNames);
  }
