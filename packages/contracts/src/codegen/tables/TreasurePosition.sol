...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("TreasurePosition")));
bytes32 constant TreasurePositionTableId = _tableId;

library TreasurePosition {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "x";
    _fieldNames[1] = "y";
    return ("TreasurePosition", _fieldNames);
  }
