...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ChallengeTrigger")));
bytes32 constant ChallengeTriggerTableId = _tableId;

library ChallengeTrigger {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ChallengeTrigger", _fieldNames);
  }
